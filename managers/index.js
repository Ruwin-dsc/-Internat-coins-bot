...
exports.Managers = class Managers {
    constructor(RosaCoins) {
        ...
        this.ores = [
            {
                name: "iron_ore",
                emoji: "<:iron_ore:818963123268091905>",
                coalRequire: 1,
                percentage: 0.23,
                result: {
                    name: "iron_ingot",
                    emoji: "<:iron_ingot:818948229638258720>",
                    price: 50
                }
            },
            {
                name: "gold_ore",
                emoji: "<:gold_ore:818952183612964914>",
                coalRequire: 1,
                percentage: 0.20,
                result: {
                    name: "gold_ingot",
                    emoji: "<:gold_ingot:818948343282532412>",
                    price: 60
                }
            },
            {
                name: "diamond_ore",
                emoji: "<:diamond_ore:818952248197513297>",
                coalRequire: 2,
                percentage: 0.15,
                result: {
                    name: "diamond_ingot",
                    emoji: "<:diamond_ingot:818948413093314652>",
                    price: 70
                }
            },
            {
                name: "emerald_ore",
                emoji: "<:emerald_ore:818952316127936572>",
                coalRequire: 0,
                timeRequire: 1000*30,
                percentage: 0.05,
                result: {
                    name: "emerald_ingot",
                    emoji: "<:emerald_ingot:818948572716072960>",
                    price: 90
                }
            },
            ...
            {
                name: "wood_pickaxe",
                emoji: "<:wood_pickaxe:818949792293060615>",
    ...
    async autoPushToDatabase(ms) {
        setInterval(async () => {
            ...
            for await (const guildManager of this.guildManager)
                ...
                } catch (e) {console.error("Error Push Guilds") }
            ...
            for await (const teamManager of this.teamManager)
                ...
                } catch (e) {console.error("Error Push Teams")}
            ...
            for await (const userManager of this.userManager)
                ...
                } catch (e) {console.error("Error Push Users")}
            ...
            for await (const printerManager of this.printerManager)
                ...
                } catch (e) {console.error("Error Push Printers")}
            ...
            for await (const characterManager of this.characterManager)
                ...
                } catch (e) {console.error("Error Push Characters") }
            ...
            for await (const mineZoneManager of this.mineZoneManager)
                ...
                } catch (e) {console.error("Error Push MineZone") }
