        ...
        message.channel.send({
            ...
            collector.on('collect', (reaction, user) => {
                ...
                if (reaction.emoji.name === "5️⃣") {
                    ...
                    const role = message.guild.roles.cache.get(guildManager.lootMobRole);
