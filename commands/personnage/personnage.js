...
personnageInv = async function (message, characterManager, userManager) {
    ...
    return new Discord.MessageEmbed()
        ...
        .setDescription(`
            **Argents:** ${userManager.coins.toLocaleString('fr-EU', {
            style: 'currency',
            currency: 'EUR',
        })}\n
             **Argents Sale:** ${userManager.dirtyCoins.toLocaleString('fr-EU', {
            style: 'currency',
            currency: 'EUR',
        })}\n
            **Vie:** \`${characterManager.health > 9 ? "❤️".repeat(parseInt(characterManager.health.toString() === "100" ? 10 : characterManager.health.toString()[0])) : `${characterManager.health.toFixed(2)} HP`}\` (${characterManager.health.toFixed(2)} HP)\n
